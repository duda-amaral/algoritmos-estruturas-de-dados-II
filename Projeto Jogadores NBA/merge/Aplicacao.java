...
public class Aplicacao {
	public static void main(String[] args) throws Exception {
		...
		mergesort(jogadoresEncontrados, 0, qtdJogadores-1); 
	...
	private static void mergesort(Jogador[] jogador, int esq, int dir) {
		if (esq < dir) {
	        	int meio = (esq + dir) / 2;
	...
	private static void intercalar(Jogador[] jogador, int esq, int meio, int dir) {
