...
public class Aplicacao {
    public static void main(String[] args) {
        ...
        while (texto != null) {
            ...
            while (!texto.equals("FIM")) {
                if (pesquisar(listaJogadores) != null) {
                    fila.enfileirar(jogadores);
                }
                imprimirMedia = (int) fila.obterMediaAltura();
		...
		for (int j = 0; j < qtd; j++) {
            ...
            if (entradaFila[0].equals("R")) {
                try {
                    Jogador desenfileirado = fila.desenfileirar();
                ...
                for (int x = 0; x < listaJogadores.length; x++) {
                    if (id == listaJogadores[x].getId()) 
                        fila.enfileirar(listaJogadores[x]);
                }
            }
            imprimirMedia = (int) fila.obterMediaAltura();
            System.out.println(imprimirMedia);
    ...
    public static Jogador pesquisar(Jogador[] lista) {
